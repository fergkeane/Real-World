...
{ kind: 'Cargo', img: 'https://images.unsplash.com/photo-1589994965851-a8f479c573a9?auto=format&fit=crop&w=2400&q=80', tag: 'Cargo', title: 'Track cargo exposure and accumulation across every global trade lane.' },
{ kind: 'Ports', img: 'https://images.unsplash.com/photo-1577416412292-747c6607f055?auto=format&fit=crop&w=2400&q=80', tag: 'Ports', title: 'Live visibility into port calls, congestion, and accumulation risk.' }];
    ...
    <div className="relative min-h-screen w-full overflow-hidden bg-ink-900">
      ...
      <header className="relative z-10 flex items-center justify-between px-8 py-6">
        <div className="flex items-center gap-2.5 text-white">
          <img src="images/skytek-realworld-landscape-white.png" alt="Real World" style={{ height: '34px', width: 'auto', display: 'block' }} />
        </div>
      ...
      <main className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 px-8 lg:px-16 pt-8 pb-20">
        ...
        <div className="text-white max-w-xl">
          ...
          <h1
            ...
            style={{ fontFamily: 'Exo, sans-serif', lineHeight: "1.2" }}>
            
            {SLIDES[idx].title}
          </h1>
          <p className="mt-5 text-base lg:text-lg text-white/80 max-w-md leading-relaxed">
            Marine, Property, Aviation, Energy, Cargo, and Ports portfolios — unified on one global map. Real-time exposure, live alerts, deep portfolio analytics.
          </p>
